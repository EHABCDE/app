...
const TRANSLATIONS = {
    ...
    uk: {
        ...
        // ---- Batch 5e (Themen Erwachsene, Teil 5/7): Hitzschlag &
        // Sonnenstich, Unterkühlung & Erfrierung, Verbrennung &
        // Verbrühung, Vergiftung, Verätzung. ----
        content_hitzschlag_erw_panic: `
                <h1 style="color: #e74c3c;">🥵 НЕВІДКЛАДНА ДОПОМОГА: ТЕПЛОВИЙ ТА СОНЯЧНИЙ УДАР</h1>

                <div class="emergency-step">
                    <span class="step-num">1</span>
                    <strong>РОЗПІЗНАЙТЕ ЦЕ:</strong> Сонячний удар - яскраво-червона, гаряча голова, скутість шиї, головний біль, нудота після впливу сонця на голову. Тепловий удар - дуже висока температура тіла, гаряча шкіра, сплутаність свідомості аж до непритомності: небезпечно для життя!
                </div>

                <div class="emergency-step">
                    <span class="step-num">2</span>
                    <strong>ПОДАЛІ ВІД СПЕКИ:</strong> Одразу перемістіться в прохолодне, затінене або кондиційоване місце.
                </div>

                <div class="emergency-step">
                    <span class="step-num">3</span>
                    <strong>ОХОЛОДЖУЙТЕ:</strong> Розстібніть або зніміть одяг, обприскайте теплуватою водою або прикладіть вологі тканини - особливо охолоджуйте шию, пахви і пахову ділянку.
                </div>
                ...
                <div class="emergency-step" style="background-color: #34495e; border-left-color: #f1c40f;">
                    <span class="step-num">5</span>
                    Пропонуйте воду маленькими ковтками лише якщо людина повністю притомна.
                </div>

                <div class="emergency-step" style="background-color: #78281f; border-color: #c0392b;">
                    <span class="step-num">6</span>
                    <strong>ТЕЛЕФОНУЙТЕ 112</strong> одразу при тепловому ударі (дуже висока температура, порушення свідомості) - без лікування він може бути небезпечним для життя!
                </div>`,
        content_hitzschlag_erw_learn: `
                <h1>🔬 Що варто знати: тепловий та сонячний удар</h1>
                <p>Сонячний удар виникає через прямий, тривалий вплив сонця на непокриту голову і подразнює мозкові оболонки - основна температура тіла зазвичай залишається нормальною. Тепловий удар, навпаки, - це перегрівання всього організму, при якому власна терморегуляція тіла виходить з ладу, і це гострий невідкладний стан.</p>

                <h3>Групи підвищеного ризику</h3>
                <p>Маленькі діти, люди похилого віку та будь-хто, хто фізично активний у сильну спеку, перебувають у групі підвищеного ризику. Достатнє пиття, головний убір і уникання яскравого полуденного сонця - ефективна профілактика.</p>`,

        content_unterkuehlung_erw_panic: `
                <h1 style="color: #2980b9;">🥶 НЕВІДКЛАДНА ДОПОМОГА: ПЕРЕОХОЛОДЖЕННЯ ТА ОБМОРОЖЕННЯ</h1>

                <div class="emergency-step">
                    <span class="step-num">1</span>
                    <strong>ПОДАЛІ ВІД ХОЛОДУ:</strong> Виведіть людину з холоду і вологи, замініть мокрий одяг сухим.
                </div>

                <div class="emergency-step">
                    <span class="step-num">2</span>
                    <strong>ЗІГРІВАЙТЕ ПОВІЛЬНО:</strong> Загорніть у ковдри (включно з термопокривалом, золотистою стороною всередину). Пропонуйте теплі солодкі напої лише якщо людина повністю притомна.
                </div>

                <div class="emergency-step" style="background-color: #78281f; border-color: #c0392b;">
                    <span class="step-num">3</span>
                    <strong>БЕЗ АЛКОГОЛЮ, БЕЗ ПРЯМОГО ТЕПЛА:</strong> Жодного гарячого душу і жодної грілки при важкому переохолодженні - це може спричинити небезпечний циркуляторний шок.
                </div>

                <div class="emergency-step" style="background-color: #34495e; border-left-color: #f1c40f;">
                    <span class="step-num">4</span>
                    <strong>РУХАЙТЕ ОБЕРЕЖНО:</strong> При важкому переохолодженні рухайте людину якомога менше і обережніше, щоб уникнути порушення серцевого ритму.
                </div>

                <div class="emergency-step">
                    <span class="step-num">5</span>
                    <strong>ОБМОРОЖЕНІ ЧАСТИНИ ТІЛА:</strong> Не розтирайте їх, зігрівайте повільно і дбайливо (наприклад, теплом власного тіла), не поливайте гарячою водою.
                </div>

                <div class="emergency-step">
                    <span class="step-num">6</span>
                    <strong>ТЕЛЕФОНУЙТЕ 112</strong> при важкому переохолодженні (сплутаність свідомості, скутість м'язів, порушення свідомості) або великому обмороженні.
                </div>`,
        content_unterkuehlung_erw_learn: `
                <h1>🔬 Що варто знати: переохолодження та обмороження</h1>
                <p>Коли основна температура тіла падає нижче 35°C, це називається переохолодженням. Спочатку тіло тремтить, щоб виробляти тепло; пізніше цей захисний механізм слабшає, рухи стають нескоординованими, а свідомість порушується.</p>

                <h3>"Рятувальний колапс" - чому обережний рух настільки важливий</h3>
                <p>При важкому переохолодженні холодна, кисла кров з кінцівок може раптово ринути до серця при різкому русі чи швидкому зігріванні і спричинити там небезпечні порушення серцевого ритму. Саме тому людям із важким переохолодженням допомагають якомога обережніше.</p>`,

        content_verbrennung_erw_panic: `
                <h1 style="color: #e67e22;">🔥 НЕВІДКЛАДНА ДОПОМОГА: ОПІКИ ТА ОШПАРЕННЯ</h1>

                <div class="emergency-step">
                    <span class="step-num">1</span>
                    <strong>ПРИПИНІТЬ ДІЮ ПРИЧИНИ:</strong> Загасіть полум'я, відійдіть від джерела тепла, обережно зніміть гарячий чи просочений одяг - якщо він не прилип до шкіри.
                </div>

                <div class="emergency-step">
                    <span class="step-num">2</span>
                    <strong>ОХОЛОДЖУЙТЕ:</strong> Одразу охолоджуйте уражену ділянку теплуватою/прохолодною (не крижаною) водою протягом 10-20 хвилин - жодного льоду безпосередньо на шкіру.
                </div>

                <div class="emergency-step">
                    <span class="step-num">3</span>
                    <strong>СТЕРИЛЬНО НАКРИЙТЕ:</strong> Після охолодження вільно накрийте стерильною, знезараженою пов'язкою.
                </div>

                <div class="emergency-step" style="background-color: #34495e; border-left-color: #f1c40f;">
                    <span class="step-num">4</span>
                    <strong>НЕ ПРОКОЛЮЙТЕ ПУХИРІ:</strong> Ніколи не проколюйте пухирі від опіку самостійно - ризик інфікування.
                </div>

                <div class="emergency-step" style="background-color: #78281f; border-color: #c0392b;">
                    <span class="step-num">5</span>
                    <strong>ТЕЛЕФОНУЙТЕ 112</strong> при великих опіках (більших за власну долоню людини), опіках обличчя, рук, суглобів чи статевих органів - для дітей і людей похилого віку завжди звертайтеся по допомогу з запасом.
                </div>

                <div class="emergency-step">
                    <span class="step-num">6</span>
                    При великому опіку припиніть охолоджувати всю ділянку (ризик переохолодження) - натомість зігрівайте людину і чекайте на швидку допомогу.
                </div>`,
        content_verbrennung_erw_learn: `
                <h1>🔬 Що варто знати: опіки та ошпарення</h1>
                <p>Опіки спричинені теплом, вогнем чи гарячими предметами, ошпарення - гарячими рідинами чи парою. Обидва класифікуються за глибиною: від поверхневого почервоніння (1 ступінь), через болісні пухирі (2 ступінь), до глибокого, часто менш болісного руйнування всіх шарів шкіри (3 ступінь).</p>

                <h3>Чому охолодження допомагає лише обмежений час</h3>
                <p>Охолодження полегшує біль і обмежує подальше пошкодження тканини вглиб. Але при великих опіках, починаючи з певного моменту, ризик переохолодження всього організму переважає користь - швидке транспортування до лікарні важливіше за подальше охолодження.</p>`,

        content_vergiftung_erw_panic: `
                <h1 style="color: #6c3483;">🧪 НЕВІДКЛАДНА ДОПОМОГА: ОТРУЄННЯ</h1>

                <div class="emergency-step">
                    <span class="step-num">1</span>
                    <strong>ЗБЕРІГАЙТЕ СПОКІЙ І ЗБЕРЕЖІТЬ ДОКАЗИ:</strong> Якщо можливо, збережіть упаковку, рештки речовини або блювотні маси для подальшої діагностики.
                </div>

                <div class="emergency-step" style="background-color: #78281f; border-color: #c0392b;">
                    <span class="step-num">2</span>
                    <strong>ЗВ'ЯЖІТЬСЯ З ТОКСИКОЛОГІЧНИМ ЦЕНТРОМ</strong> і запитайте пораду. Номер відповідального токсикологічного центру можна також отримати, зателефонувавши 112.
                </div>

                <div class="emergency-step" style="background-color: #34495e; border-left-color: #f1c40f;">
                    <span class="step-num">3</span>
                    <strong>НЕ РОБІТЬ НІЧОГО БЕЗ ПОРАДИ:</strong> Не викликайте блювання і не давайте молоко чи вугілля, якщо це не було прямо рекомендовано - при їдких речовинах блювання може спричинити додаткове пошкодження.
                </div>

                <div class="emergency-step">
                    <span class="step-num">4</span>
                    <strong>ПРИ ТОКСИЧНИХ ВИПАРАХ/ГАЗАХ:</strong> Одразу виведіть людину на свіже повітря, захистіть себе - не заходьте самі в приміщення, наповнене димом чи газом.
                </div>

                <div class="emergency-step" style="background-color: #78281f; border-color: #c0392b;">
                    <span class="step-num">5</span>
                    <strong>ТЕЛЕФОНУЙТЕ 112</strong> при порушенні свідомості, труднощах з диханням, судомах, або якщо було вжито велику кількість речовини чи невідому речовину.
                </div>

                <div class="emergency-step">
                    <span class="step-num">6</span>
                    Слідкуйте за диханням і свідомістю; якщо людина непритомна, але дихає нормально, покладіть її в стабільне бокове положення.
                </div>`,
        content_vergiftung_erw_learn: `
                <h1>🔬 Що варто знати: отруєння</h1>
                <p>У дорослих отруєння часто трапляється через сплутані чи передозовані ліки, алкоголь, побутову хімію, або вдихання токсичних газів, таких як чадний газ. Симптоми варіюються від нудоти до сплутаності свідомості і непритомності.</p>

                <h3>Чому токсикологічний центр настільки важливий</h3>
                <p>Токсикологічні центри знають дію тисяч речовин і можуть дати цільову пораду на основі кількості, часу та типу речовини - це часто дозволяє уникнути зайвої паніки або допомагає викликати саме правильну реакцію.</p>`,

        content_veraetzung_erw_panic: `
                <h1 style="color: #7f8c8d;">⚗️ НЕВІДКЛАДНА ДОПОМОГА: ХІМІЧНИЙ ОПІК (ШКІРА ТА ОКО)</h1>

                <div class="emergency-step">
                    <span class="step-num">1</span>
                    <strong>ПРИПИНІТЬ КОНТАКТ:</strong> Одразу зніміть забруднений одяг - уникайте потрапляння хімічної речовини на власну шкіру, за потреби використовуйте рукавички.
                </div>

                <div class="emergency-step" style="background-color: #78281f; border-color: #c0392b;">
                    <span class="step-num">2</span>
                    <strong>ДОВГО Й РЕТЕЛЬНО ПРОМИВАЙТЕ:</strong> Одразу промийте уражену шкіру чи око великою кількістю чистої теплуватої води щонайменше 10-15 хвилин. Для ока промивайте від носа назовні, тримаючи повіки відкритими.
                </div>

                <div class="emergency-step" style="background-color: #34495e; border-left-color: #f1c40f;">
                    <span class="step-num">3</span>
                    <strong>НЕ НЕЙТРАЛІЗУЙТЕ:</strong> Ніколи не намагайтеся нейтралізувати кислоти чи луги протилежною речовиною - тепло, що при цьому виділяється, може погіршити травму.
                </div>

                <div class="emergency-step">
                    <span class="step-num">4</span>
                    <strong>СТЕРИЛЬНО НАКРИЙТЕ</strong> після промивання, вільно чистою, знезараженою пов'язкою.
                </div>

                <div class="emergency-step" style="background-color: #78281f; border-color: #c0392b;">
                    <span class="step-num">5</span>
                    <strong>ТЕЛЕФОНУЙТЕ 112</strong> при великих хімічних опіках, опіках обличчя/ока, або якщо хімічна речовина була проковтнута. Тримайте напоготові упаковку або паспорт безпеки для бригади швидкої допомоги.
                </div>`,
        content_veraetzung_erw_learn: `
                <h1>🔬 Що варто знати: хімічні опіки</h1>
                <p>Кислоти і луги - що містяться в засобах для чищення, акумуляторній кислоті чи промислових хімікатах - руйнують шари шкіри при контакті і можуть спричинити незворотне пошкодження, якщо потрапляють в очі.</p>

                <h3>Чому тривале промивання настільки важливе</h3>
                <p>Лише достатньо довге промивання розводить і повністю видаляє хімічну речовину зі шкіри чи ока. Якщо зупинитися занадто рано, речовина продовжує діяти, і пошкодження продовжує посилюватися.</p>`,
        ...
        content_herzinfarkt_erw_learn: `
                ...
                <h3>Чому кожна хвилина важлива</h3>
                <p>Чим швидше закупорена судина буде відкрита в лікарні, тим більше тканини серцевого м'яза вдасться врятувати. Інфаркт міокарда також є однією з найпоширеніших причин раптової зупинки серця, тому за станом людини потрібно уважно спостерігати до приїзду швидкої допомоги.</p>`,
        ...
        content_schlaganfall_erw_learn: `
                ...
                <h3>Чому тест FAST і час мають таке велике значення</h3>
        ...
        content_sepsis_erw_learn: `
                ...
                <h3>Чому важлива швидка реакція</h3>
                <p>Як і при інфаркті міокарда та інсульті, при сепсисі діє правило: чим раніше починається лікування антибіотиками та підтримка кровообігу, тим кращі шанси на виживання. Немовлята, літні люди та особи з ослабленим імунітетом перебувають у групі особливого ризику.</p>`,

        content_bauchschmerz_erw_panic: `
                <h1 style="color: #af601a;">🤢 НЕВІДКЛАДНА ДОПОМОГА: ГОСТРИЙ БІЛЬ У ЖИВОТІ</h1>

                <div class="emergency-step">
                    <span class="step-num">1</span>
                    <strong>СПОКІЙ:</strong> Покладіть людину із зігнутими колінами, щоб розслабити черевну стінку.
                </div>

                <div class="emergency-step" style="background-color: #34495e; border-left-color: #f1c40f;">
                    <span class="step-num">2</span>
                    <strong>НЕ ДАВАЙТЕ НІЧОГО ЇСТИ ЧИ ПИТИ</strong>, поки причина не з'ясована - якщо знадобиться операція, шлунок бажано мати порожнім.
                </div>

                <div class="emergency-step" style="background-color: #34495e; border-left-color: #f1c40f;">
                    <span class="step-num">3</span>
                    <strong>ЖОДНИХ ЗНЕБОЛЮВАЛЬНИХ</strong> без консультації лікаря - вони можуть маскувати симптоми і ускладнити діагностику.
                </div>

                <div class="emergency-step">
                    <span class="step-num">4</span>
                    Слідкуйте за попереджувальними ознаками: твердий, напружений живіт, сильний або посилюваний біль, гарячка, блювання (особливо з кров'ю), кров у калі або слабкість кровообігу.
                </div>
        ...
        content_bauchschmerz_erw_learn: `
                ...
                <p>Раптовий, сильний біль у животі (так званий "гострий живіт") може мати багато причин - від апендициту до жовчної коліки чи кишкової непрохідності. Як людина, що надає першу допомогу, ви не можете визначити точну причину, але важливо не втрачати часу.</p>

                <h3>Чому варто уникати знеболювальних</h3>
                <p>Знеболювальні можуть маскувати типові попереджувальні ознаки, за якими лікарі визначають причину. Тому їх слід давати в гострому випадку лише за призначенням лікаря.</p>`,

        // ---- Batch 5g (Themen Erwachsene, Teil 7/7 - letzter Batch): Астматичний напад, Судомний напад. ----
        content_asthma_erw_panic: `
                <h1 style="color: #2471a3;">😮‍💨 НЕВІДКЛАДНА ДОПОМОГА: АСТМАТИЧНИЙ НАПАД</h1>

                <div class="emergency-step">
                    <span class="step-num">1</span>
                    <strong>ЗБЕРІГАЙТЕ СПОКІЙ:</strong> Заспокойте людину - страх і хвилювання посилюють задишку.
                </div>

                <div class="emergency-step">
                    <span class="step-num">2</span>
                    <strong>ПОЛОЖЕННЯ З НАХИЛОМ ВПЕРЕД:</strong> Посадіть людину прямо, руки спираються на стегна чи край столу - це полегшує роботу допоміжних дихальних м'язів.
                </div>

                <div class="emergency-step">
                    <span class="step-num">3</span>
                    <strong>ОСЛАБТЕ ТІСНИЙ ОДЯГ</strong> і забезпечте доступ свіжого, не надто холодного повітря.
                </div>

                <div class="emergency-step" style="background-color: #34495e; border-left-color: #f1c40f;">
                    <span class="step-num">4</span>
                    <strong>ІНГАЛЯТОР ШВИДКОЇ ДІЇ:</strong> При відомій астмі запитайте про інгалятор швидкої дії і допоможіть ним скористатися.
                </div>

                <div class="emergency-step">
                    <span class="step-num">5</span>
                    <strong>СКЕРУЙТЕ ДИХАННЯ ЧЕРЕЗ ЗІМКНУТІ ГУБИ:</strong> Попросіть повільно видихати через трохи стиснуті губи - це довше утримує дихальні шляхи відкритими.
                </div>

                <div class="emergency-step" style="background-color: #78281f; border-color: #c0392b;">
                    <span class="step-num">6</span>
                    <strong>ВИКЛИЧТЕ 112</strong> при сильній, посилюваній задишці, синюшних губах, виснаженні або якщо інгалятор швидкої дії не допомагає.
                </div>`,
        content_asthma_erw_learn: `
                <h1>🔬 Що варто знати: астматичний напад</h1>
                <p>Під час астматичного нападу дихальні шляхи звужуються через спазм м'язів, набряк слизової оболонки та посилене виділення слизу. Видих стає особливо утрудненим, часто чутний свист.</p>

                <h3>Чому допомагають спокій і положення тіла</h3>
                <p>Пряме положення сидячи з опорою на руки полегшує роботу допоміжних дихальних м'язів, а дихання через зімкнуті губи створює легкий зворотний тиск, який утримує дихальні шляхи відкритими на видиху. Стрес і паніка посилюють звуження дихальних шляхів, тому спокійна розмова - важлива частина першої допомоги.</p>`,

        content_krampfanfall_erw_panic: `
                <h1 style="color: #6c3483;">⚡ НЕВІДКЛАДНА ДОПОМОГА: СУДОМНИЙ НАПАД</h1>

                <div class="emergency-step">
                    <span class="step-num">1</span>
                    <strong>ЗБЕРІГАЙТЕ СПОКІЙ:</strong> Судомний напад часто виглядає драматично, але зазвичай триває лише 1-3 хвилини і припиняється сам собою.
                </div>

                <div class="emergency-step">
                    <span class="step-num">2</span>
                    <strong>ЗАПОБІЖІТЬ ТРАВМУВАННЮ:</strong> Приберіть небезпечні предмети, підкладіть під голову щось м'яке (одяг, куртку).
                </div>

                <div class="emergency-step" style="background-color: #78281f; border-color: #c0392b;">
                    <span class="step-num">3</span>
                    <strong>НІЧОГО НЕ КЛАДІТЬ ДО РОТА</strong> і НЕ утримуйте людину силою та не намагайтеся зупинити рухи - це може спричинити травму.
                </div>

                <div class="emergency-step">
                    <span class="step-num">4</span>
                    <strong>ПІСЛЯ НАПАДУ:</strong> Щойно посмикування припиниться, покладіть людину в стабільне бокове положення і перевірте дихання.
                </div>

                <div class="emergency-step" style="background-color: #34495e; border-left-color: #f1c40f;">
                    <span class="step-num">5</span>
                    Засічіть, скільки триває напад.
                </div>

                <div class="emergency-step">
                    <span class="step-num">6</span>
                    <strong>ВИКЛИЧТЕ 112</strong>, якщо напад триває довше 5 хвилин, якщо кілька нападів відбуваються один за одним, якщо людина травмувалася, якщо це її перший відомий напад, або якщо після нього вона не приходить до тями.
                </div>`,
        content_krampfanfall_erw_learn: `
                <h1>🔬 Що варто знати: судомний напад</h1>
                <p>Судомний напад виникає через раптову, надмірну електричну активність у мозку і може проявлятися посмикуванням усього тіла, а також тихими епізодами "відключення" ("абсансами"). Відомою причиною є епілепсія, але судоми можуть викликати також гарячка (див. фебрильні судоми в розділі "Немовля та дитина"), низький рівень цукру в крові чи травми голови.</p>

                <h3>Чому не можна утримувати людину силою</h3>
                <p>Насильне стримування судомних рухів може спричинити переломи чи травми м'язів. Важливіше убезпечити оточення і захистити голову, поки напад не пройде сам собою.</p>`,

        // ---- Batch 6 (Abschluss): Utility-Screens Feedback, Notrufnummern, Notfallpass. ----
        content_feedback: `
                ...
                <div style="background: #ffffff; padding: 20px; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); border: 1px solid #cbd5e1; margin-bottom: 20px; color: #2c3e50;">
                    ...
                    <a href="mailto:info@erstehilfeabc.de?subject=%5BErste%20Hilfe%20ABC%20App%5D%20Fehlermeldung" target="_blank" style="display: block; background-color: #e74c3c; color: white !important; text-decoration: none; padding: 14px 20px; border-radius: 25px; font-weight: bold; font-size: 15px; text-align: center; box-shadow: 0 4px 6px rgba(0,0,0,0.1); margin-top: 10px;">
                        🚨 Повідомити про помилку електронною поштою
                    </a>
                </div>

                <div style="background: #ffffff; padding: 20px; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); border: 1px solid #cbd5e1; color: #2c3e50;">
                    <h3 style="margin-top: 0;">💡 Ідея чи пропозиція?</h3>
                    <p style="font-size: 14px; line-height: 1.5;">Бракує теми з першої допомоги, є порада для перевірки безпеки вдома, чи є ідеї, як покращити додаток? Буду радий почути від вас!</p>

                    <a href="mailto:info@erstehilfeabc.de?subject=%5BErste%20Hilfe%20ABC%20App%5D%20Feedback%20%26%20Idee" target="_blank" style="display: block; background-color: #2980b9; color: white !important; text-decoration: none; padding: 14px 20px; border-radius: 25px; font-weight: bold; font-size: 15px; text-align: center; box-shadow: 0 4px 6px rgba(0,0,0,0.1); margin-top: 10px;">
                        ✉️ Надіслати пропозицію електронною поштою
                    </a>
                </div>`,

        content_notrufnummern: `
        <h1 style="color: #c0392b;">📞 Важливі номери екстреної допомоги</h1>
        <p>Натисніть на номер, щоб одразу зателефонувати:</p>

        <!-- 112 EMERGENCY -->
        <div style="background: #2c0e0e; padding: 18px; border-radius: 12px; border-left: 5px solid #e74c3c; color: white; margin-bottom: 15px;">
            <strong style="font-size: 18px; color: #e74c3c;">🚨 Швидка допомога та пожежна служба</strong>
            <p style="margin: 5px 0 12px 0; font-size: 13px; color: #cbd5e1;">При загрозі життю, втраті свідомості чи гострих проблемах з диханням.</p>
            <a href="tel:112" style="display: block; background: #e74c3c; color: white !important; text-decoration: none; padding: 12px; border-radius: 25px; font-weight: bold; text-align: center; font-size: 18px;">
                📞 Зателефонувати 112
            </a>
        </div>
        ...
        <!-- 116 117 OUT-OF-HOURS DOCTOR SERVICE -->
        <div style="background: #ffffff; padding: 18px; border-radius: 12px; border: 1.5px solid #cbd5e1; border-left: 5px solid #2980b9; margin-bottom: 15px;">
            <strong style="font-size: 18px; color: #2980b9;">🩺 Чергова лікарська служба</strong>
            <p style="margin: 5px 0 12px 0; font-size: 13px; color: #475569;">Ночами та у вихідні, коли лікарський кабінет зачинений (не для екстрених випадків).</p>
            <a href="tel:116117" style="display: block; background: #2980b9; color: white !important; text-decoration: none; padding: 12px; border-radius: 25px; font-weight: bold; text-align: center; font-size: 18px;">
                📞 Зателефонувати 116 117
            </a>
        </div>

       <!-- GIFTNOTRUF (DYNAMISCH JE NACH BUNDESLAND) -->
        <div style="background: #ffffff; padding: 18px; border-radius: 12px; border: 1.5px solid #cbd5e1; border-left: 5px solid #27ae60; margin-bottom: 15px;">
            <strong style="font-size: 18px; color: #1e8449;">🧪 Токсикологічний центр</strong>
            <p style="margin: 5px 0 8px 0; font-size: 13px; color: #475569;">При підозрі на отруєння рослинами, засобами для чищення чи ліками.</p>

            <!-- Dynamischer Standort-Hinweis -->
            <div id="poison-location-info" style="font-size: 12px; color: #64748b; margin-bottom: 10px;">
                📍 <em>Пошук токсикологічного центру для вашого місцезнаходження...</em>
            </div>

            <!-- Dynamischer Anruf-Button -->
            <a id="poison-call-btn" href="tel:055119240" style="display: block; background: #27ae60; color: white !important; text-decoration: none; padding: 12px; border-radius: 25px; font-weight: bold; text-align: center; font-size: 16px;">
                📞 Зателефонувати до токсикологічного центру
            </a>
        </div>

        <!-- POLIZEI -->
        <div style="background: #ffffff; padding: 18px; border-radius: 12px; border: 1.5px solid #cbd5e1; border-left: 5px solid #34495e; margin-bottom: 15px;">
            <strong style="font-size: 18px; color: #34495e;">👮 Поліція</strong>
            <p style="margin: 5px 0 12px 0; font-size: 13px; color: #475569;">При аваріях, крадіжках зі зломом чи гострій небезпеці.</p>
            <a href="tel:110" style="display: block; background: #34495e; color: white !important; text-decoration: none; padding: 12px; border-radius: 25px; font-weight: bold; text-align: center; font-size: 16px;">
                📞 Зателефонувати 110
            </a>
        </div>`,
        ...
        content_notfallpass: `
                <h1 style="color: #27ae60;">📋 Дитяча картка невідкладної допомоги та SOS-системи</h1>
                <p style="font-size: 14px; color: #475569; line-height: 1.5;">У невідкладній ситуації важлива кожна секунда. Рятувальники чи випадкові свідки повинні одразу побачити наявні захворювання, алергії чи ваші контактні дані.</p>

                <div style="background: #ffffff; padding: 18px; border-radius: 12px; border: 1px solid #cbd5e1; margin-bottom: 20px; color: #2c3e50;">
                    <strong style="font-size: 16px; color: #1e8449;">💡 Яка інформація має бути на SOS-браслеті?</strong>
                    <ul style="margin-top: 10px; padding-left: 20px; font-size: 14px; color: #475569; line-height: 1.6;">
                        <li><strong>Номер телефону батьків:</strong> (Завжди з кодом країни, напр. +49...)</li>
                        <li><strong>Важливі наявні захворювання:</strong> (напр. астма, діабет, епілепсія)</li>
                        <li><strong>Тяжкі алергії:</strong> (напр. на пеніцилін, укуси бджіл/ос, арахіс)</li>
                        <li><strong>Група крові:</strong> (Необов'язково, якщо відомо)</li>
                    </ul>
                </div>

                <!-- AFFILIATE BOX: SOS ARMBAND -->
                <div class="product-box">
                    <strong>🛡️ Рекомендація: SOS-браслет для екстреної допомоги з NFC та QR-кодом</strong><br>
                    Водонепроникний, надзвичайно міцний, ідеально підходить для дитячого майданчика, садочка, відпустки чи поїздок на день. Рятувальники чи медики просто прикладають смартфон до браслета і одразу бачать контактні дані та інформацію про невідкладну допомогу, якою ви поділилися.
                    <br><br>
                    💡 <strong>Порада ABC:</strong> Ніякого гравіювання, яке може стертися - контактні дані батьки можуть будь-коли оновити онлайн!
                    <a href="https://www.amazon.de/s?k=sos+notfallarmband+kinder+nfc+qr&amp;tag=ehabc-21" target="_blank" class="product-link-btn" style="background-color: #ff9900; color: #111111 !important;">
                        📦 Переглянути водонепроникні SOS-браслети для дітей на Amazon →
                    </a>
                </div>`
    }
};
