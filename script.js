...
// Ukrainische Übersetzungen der riskQuestions-Texte, überlagern per rq()-Helfer
// das deutsche Original bei aktiver ukrainischer Sprache - condition()/id/
// amazonLink bleiben unverändert.
const RISK_QUESTIONS_UK = {
    hallway_doors: {
        title: "🚪 Вхідні двері та доступ до вулиці захищені",
        text: "Вхідні двері завжди замкнені або зафіксовані ланцюжком/засувкою, а хвіртка недоступна для дитини?",
        tip: "Запобігає тому, щоб дитина непомітно вийшла на вулицю, або щоб сторонні непомітно зайшли в дім.",
        explanation: "Щойно діти навчаються ходити, вони тягнуться до дверних ручок. Запобіжна засувка або карабін на хвіртці гарантують, що малюк не вибіжить на вулицю непомітно.",
        amazonText: "👉 Погляньте на ці прості замки на дверну ручку - у нас чудово спрацювали →"
    },
    tripping_hazards: {
        title: "👟 Небезпека спіткнутися в коридорі та на шляхах пересування",
        text: "Чи прибрані вільні килимки, доріжки або декоративні предмети з місць, якими ви щодня ходите?",
        tip: "Поки ви носите дитину на руках, будь-яке ваше падіння - це пряма небезпека для вас обох.",
        explanation: "Поки дитину регулярно носять на руках, навіть невеликі перешкоди можуть швидко призвести до серйозного падіння. Приберіть вільні килимки або закріпіть їх протиковзними накладками.",
        amazonText: "👉 Я вдома користуюся такими протиковзними підкладками для килимів - тримають дуже надійно →"
    },
    cooktop_guard: {
        title: "🍳 Захисні ґрати на плиту та замок духовки",
        text: "Чи встановлені захисні ґрати на плиту і чи замкнені дверцята духовки?",
        tip: "Плита та каструлі - одна з головних причин важких опіків окропом у малюків.",
        explanation: "Підтягуючись, діти хапаються за ручки каструль або вмикають плиту. Захисні ґрати надійно блокують доступ.",
        amazonText: "👉 Ми користувалися такими захисними ґратами без свердління - справжня знахідка →"
    },
    high_chair: {
        title: "🪑 Безпека та ремені стільчика для годування",
        text: "Чи завжди дитина пристебнута в стільчику для годування, і чи стійкий стілець проти перекидання?",
        tip: "Дитина відштовхується ніжками від столу і може перекинутися назад разом зі стільцем.",
        explanation: "Падіння зі стільчика для годування - одна з найчастіших причин травм голови у віці 1-2 років. Завжди застібайте ремінь між ніжками у стільчику!",
        amazonText: "👉 Погляньте на цей універсальний 5-точковий ремінь безпеки для дитячих стільчиків →"
    },
    fridge_alcohol: {
        title: "🍾 Алкоголь та холодильник під захистом",
        text: "Чи стоять алкогольні напої високо, і чи захищений холодильник від випадкового відкриття?",
        tip: "Навіть кілька ковтків міцного алкоголю можуть спричинити важке отруєння та різке зниження цукру в крові у малюків.",
        explanation: "Діти плутають яскраві пляшки або коктейлі із соком. Алкоголь має зберігатися замкненим і недоступним.",
        amazonText: "👉 Ці непомітні замки на холодильник чудово працюють і запобігають зайвим сваркам →"
    },
    bath_mats: {
        title: "🧼 Протиковзний килимок у ванні та душі",
        text: "Чи лежать у ванні та душі протиковзні гумові килимки?",
        tip: "Запобігає неприємним розсіченням потилиці під час купання.",
        explanation: "Мокра плитка й акрилові ванни стають слизькими, як скло. Простий протиковзний килимок одразу дає маленьким ніжкам опору під час стояння.",
        amazonText: "👉 Моїм дітям дуже подобалися ці милі протиковзні наклейки для ванни →"
    },
    toilet_chem: {
        title: "🚽 Ароматизатори для унітаза та засоби для чищення",
        text: "Чи прибрані ароматизатори/засоби від вапняного нальоту з унітазу, або чи захищена кришка унітазу?",
        tip: "Ароматизатори для унітазу містять токсичні хімічні речовини, які малюк одразу може спробувати на смак.",
        explanation: "Яскраві таблетки в унітазі приваблюють дітей. У період раннього дитинства краще повністю відмовитися від таких підвісних засобів.",
        amazonText: "👉 Якщо хочете захистити кришку унітазу: ці клацаючі замки чудово справляються →"
    },
    sockets: {
        title: "🔌 Розетки на рівні підлоги",
        text: "Чи всі доступні розетки обладнані обертовими або гвинтовими заглушками безпеки?",
        tip: "Розетки притягують дітей, наче магніт. Захисні заглушки запобігають небезпечному для життя ураженню струмом.",
        explanation: "Щойно дитина починає повзати, вона досліджує отвори біля підлоги. Незахищені розетки - одна з найбільших небезпек у домі.",
        amazonText: "👉 Я одразу встановив(-ла) набір із 20 обертових заглушок для розеток - сидять ідеально →"
    },
    furniture_anchors: {
        title: "🧱 Полиці та шафи закріплені до стіни",
        text: "Чи закріплені окремо стоячі шафи, полиці та комоди у верхній третині надійно до стіни?",
        tip: "Під час лазіння або висування шухляд центр ваги зміщується - меблі можуть перекинутися!",
        explanation: "Меблі, що перекидаються, спричиняють найважчі травми черепа та грудної клітки. Завжди міцно кріпіть полиці до стіни дюбелями.",
        amazonText: "👉 Погляньте на ці непомітні кріплення проти перекидання меблів - легко встановити →"
    },
    fireplace_guard: {
        title: "🔥 Камін та засоби для розпалювання",
        text: "Чи огороджений камін захисними ґратами, і чи повністю недоступні запальнички?",
        tip: "Скло каміна нагрівається до дуже високих температур - дотик одразу спричиняє опіки третього ступеня.",
        explanation: "Окрім небезпеки опіку від скла, сірники та засоби для розпалювання токсичні та пожежонебезпечні.",
        amazonText: "👉 Ми користуємося таким захисним екраном із дверцятами протягом опалювального сезону - дуже надійний →"
    },
    baby_sids: {
        title: "🛏️ Безпечне середовище для сну (профілактика СРДС)",
        text: "Чи спить ваша дитина у спальному мішку на твердому матраці - без подушок, бортиків, хутра чи м'яких іграшок?",
        tip: "Запобігає перегріванню та перекриттю дихальних шляхів у ліжечку.",
        explanation: "Жодних ковдр чи подушок протягом першого року життя! Малюки регулюють температуру тіла через голову і не повинні перегріватися.",
        amazonText: "👉 Ми завжди користувалися такими дихаючими дитячими спальними мішками - справді чудові →"
    },
    cords_blind: {
        title: "🧵 Шнури жалюзі та штор",
        text: "Чи намотані шнури від жалюзі, штор або кордів високо й недоступно для дитини?",
        tip: "Небезпека удушення! Діти під час гри можуть швидко заплутатися у звисаючих петлях.",
        explanation: "Довгі шнури на рівні дитини - недооцінена небезпека. Намотайте їх на спеціальний намотувач або вкоротіть.",
        amazonText: "👉 Ці невеликі намотувачі для віконних шнурів одразу роблять їх безпечними →"
    },
    doors_windows: {
        title: "🚪 Вікна, двері та гострі кути",
        text: "Чи можна замкнути віконні ручки, чи встановлені обмежувачі на дверях, і чи захищені кути столу?",
        tip: "Запобігає падінню з вікна, защемленню пальців та розсіченням голови.",
        explanation: "Замініть віконні ручки в господарському магазині на ті, що замикаються. Захист від защемлення на дверях запобігає травмам пальців.",
        amazonText: "👉 Ми просто надягаємо такі м'які поролонові обмежувачі зверху на дверне полотно →"
    },
    gp_meds: {
        title: "👴 У бабусі та дідуся: ліки та сумочки",
        text: "Чи всі таблетки, ліки від серця/тиску та сумочки недоступні під час візитів до родичів?",
        tip: "Ліки від серця чи тиску бабусі й дідуся навіть у найменшій дозі можуть бути смертельними для малюка!",
        explanation: "Отруєння часто трапляються там, де середовище не є постійно безпечним для дітей. Сумочка бабусі на підлозі - класичне джерело небезпеки.",
        amazonText: "👉 Погляньте на ці сумки для ліків, що замикаються, для візитів у гості →"
    },
    toxic_plants: {
        title: "🪴 Отруйні рослини та ґрунт у горщиках",
        text: "Чи прибрані отруйні кімнатні рослини (наприклад, диффенбахія, орхідеї, плющ), і чи прикритий ґрунт у горщиках?",
        tip: "Ґрунт у горщику приваблює дитину копати в ньому; багато кімнатних рослин при жуванні спричиняють важкі хімічні опіки.",
        explanation: "У разі сумніву запитайте у флориста. Якщо не впевнені - краще віддайте потенційно отруйні рослини комусь іншому.",
        amazonText: "👉 Існують зручні захисні решітки для горщиків, які не дають викопувати землю →"
    },
    pets_rules: {
        title: "🐈 Домашні тварини, лоток та корм",
        text: "Чи недоступні лоток і миски з кормом, і чи НІКОЛИ дитина не залишається наодинці з твариною?",
        tip: "Тварини можуть непередбачувано реагувати в незвичних ситуаціях - особливо якщо їх тягнуть за шерсть.",
        explanation: "Навчіть дитину змалку, що миска і місце для сну тварини - абсолютне табу. Ніколи не залишайте дитину й тварину без нагляду в одній кімнаті.",
        amazonText: "👉 Ми користуємося цими воротами з дверцятами для кота - собака/кіт проходять, дитина - ні →"
    },
    water_safety: {
        title: "🌊 Ставок у саду, басейн та бочка для дощової води",
        text: "Чи повністю огороджені ставки/басейни, і чи міцно закручені бочки для дощової води?",
        tip: "Утоплення відбувається тихо! Малюк може піти під воду без жодного звуку та крику про допомогу - навіть на мілководді.",
        explanation: "У малюків важка голова та рефлекторна реакція на шок. Огороджуйте ставки повністю або захищайте їх міцною решіткою.",
        amazonText: "👉 Ця міцна захисна сітка для ставка тримає дуже надійно →"
    },
    garage_chem: {
        title: "🧰 Гараж, сарай та добрива",
        text: "Чи завжди замкнені сарай і гараж, якщо там зберігаються засоби захисту рослин, мастила та інструменти?",
        tip: "Отрути для рослин та засоби для розпалювання спричиняють найважчі отруєння.",
        explanation: "Гараж і сарай мають завжди залишатися замкненими. Ніколи не переливайте добрива чи засоби для чищення у пляшки з-під напоїв!",
        amazonText: "👉 Міцний навісний замок надійно захищає садовий сарай →"
    },
    child_seat_condition: {
        title: "🚗 Дитяче автокрісло: стан та історія ДТП",
        text: "Чи користуєтеся ви новим автокріслом, або таким, повну історію якого знаєте на 100%?",
        tip: "Автокрісла зазвичай слід купувати НОВИМИ! Навіть незначна аварія чи падіння можуть спричинити непомітні мікротріщини в матеріалі, які зведуть нанівець захист під час реальної аварії.",
        explanation: "Вживані крісла від незнайомих людей несуть високий ризик: мікротріщини в пластиковій конструкції неможливо побачити ззовні. Після будь-якої аварії (навіть на низькій швидкості) крісло потрібно замінити. Також слідкуйте, щоб не пристібати дитину в кріслі в товстому зимовому одязі - ремінь тоді матиме занадто великий люфт.",
        amazonText: "👉 Ми обираємо крісла проти напрямку руху з ISOFIX - подивіться на актуальних переможців тестів →"
    },
    child_seat_sos_label: {
        title: "🏷️ Картки з екстреними даними та контактами на автокріслі",
        text: "Чи позначене автокрісло вашими контактними даними, наявними захворюваннями та ім'ям дитини?",
        tip: "Якщо водій непритомний після аварії, рятувальники одразу дізнаються ім'я дитини та кого сповістити!",
        explanation: "У невідкладній ситуації важлива кожна секунда. Водостійка картка або наклейка прямо на задній стороні автокрісла дає рятувальникам життєво важливу інформацію (ім'я, вік, алергії, контакти бабусь/дідусів чи батьків для екстрених випадків), якщо самі батьки не можуть надати цю інформацію.",
        amazonText: "👉 Ми самі користуємося такими наклейками для екстрених випадків на автокрісла - можна одразу підписати, помітні →"
    }
};
...
// Sprach-Schlüssel -> Übersetzungs-Dictionary für die riskQuestions (siehe rq()
// unten). Neue Sprachen können hier einfach ergänzt werden.
const RISK_QUESTIONS_BY_LANG = {
    en: RISK_QUESTIONS_EN,
    uk: RISK_QUESTIONS_UK
};

// Liefert das übersetzte Feld einer riskQuestions-Frage (Titel, Text, Tipp,
// Erklärung, Amazon-Text), sofern eine Übersetzung für die aktive Sprache
// hinterlegt ist - sonst Fallback auf das deutsche Original.
function rq(q, field) {
    const dict = RISK_QUESTIONS_BY_LANG[currentLang];
    if (dict && dict[q.id] && dict[q.id][field] !== undefined) {
        return dict[q.id][field];
    }
    return q[field];
}
